...
export class GlyphWeightModifier implements Charm {
    ...
    apply() {
        ...
        if (this.glyphType) {
            console.log(`Applying weight modifier ${this.value} to ${this.glyphType}`);
...
export class GlyphPayoutModifier implements Charm {
    ...
    apply() {
        ...
        if (this.glyphType) {
            console.log(`Applying payout modifier ${this.value} to ${this.glyphType}`);
...
export class PatternTypeMultiplierModifier implements Charm {
    ...
    apply() {
        ...
        console.log(`Applying pattern type ${this.patternType} multiplier ${this.value}`);
...
export class PatternGroupMultiplierModifier implements Charm {
    ...
    apply() {
        ...
        console.log(`Applying pattern group ${this.group} multiplier ${this.value}`);
        // Example: Adjusting the payout values of winning patterns
